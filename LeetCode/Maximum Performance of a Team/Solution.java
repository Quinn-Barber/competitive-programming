class Solution {
    public int maxPerformance(int n, int[] speed, int[] efficiency, int k) {
        ...
        // Sort the players based on efficiency in decreasing order, as for each
        // iteration, we'll consider only players with higher efficiency.
        Arrays.sort(players, (p1, p2) -> (p2[0] - p1[0]));

        // Priority-Queue to maintain players with highest relative speeds with
        // efficiencies greater than the one under iteration.
